...
export const editorialItems: EditorialItem[] = [
  ...
  },
  {
    ...
    locales: {
      es: { slug: 'ensalada-tomate-cebolla-roja-aceite-oliva-bio', title: 'Ensalada de tomate, cebolla roja y aceite de oliva bio', description: 'Una ensalada rápida de tomate, cebolla roja y aceite de oliva bio para dos personas.', intro: 'Esta ensalada deja que unos pocos ingredientes bien preparados hablen por sí mismos.', imageAlt: 'Tomates frescos del catálogo de Bionatura.', ctaLabel: 'Consultar ingredientes en el catálogo', sections: [{ heading: 'Una ensalada para el día a día', paragraphs: ['Corta el tomate justo antes de servir para conservar su jugo y textura.', 'La cebolla roja aporta un contraste suave; ajusta la cantidad a tu gusto.'] }, { heading: 'Sírvela sin prisas', paragraphs: ['Deja reposar la ensalada unos minutos para que se integren los sabores.', 'Acompáñala con pan, huevo o una preparación sencilla de verduras.'] }] },
      en: { slug: 'tomato-red-onion-organic-olive-oil-salad', title: 'Tomato, red onion and organic olive oil salad', description: 'A quick tomato, red onion and organic olive oil salad for two people.', intro: 'This salad lets a few well-prepared ingredients speak for themselves.', imageAlt: 'Fresh tomatoes from the Bionatura catalogue.', ctaLabel: 'Browse ingredients in the catalogue', sections: [{ heading: 'An everyday salad', paragraphs: ['Cut the tomato just before serving to keep its juices and texture.', 'Red onion brings a gentle contrast; adjust the amount to your taste.'] }, { heading: 'Serve it at an easy pace', paragraphs: ['Let the salad rest for a few minutes so the flavours come together.', 'Serve it with bread, egg or a simple vegetable dish.'] }] },
      fi: { slug: 'tomaatti-punasipuli-luomuoliivioljy-salaatti', title: 'Tomaatti-, punasipuli- ja luomuoliiviöljysalaatti', description: 'Nopea tomaatti-, punasipuli- ja luomuoliiviöljysalaatti kahdelle.', intro: 'Tässä salaatissa muutama hyvin valmisteltu raaka-aine pääsee oikeuksiinsa.', imageAlt: 'Tuoreita tomaatteja Bionaturan luettelosta.', ctaLabel: 'Tutustu aineksiin luettelossa', sections: [{ heading: 'Arjen salaatti', paragraphs: ['Leikkaa tomaatti juuri ennen tarjoilua, jotta mehevyys ja rakenne säilyvät.', 'Punasipuli tuo mietoa vastapainoa; säädä määrä omaan makuusi.'] }, { heading: 'Tarjoile rauhassa', paragraphs: ['Anna salaatin levätä muutama minuutti, jotta maut yhdistyvät.', 'Tarjoa leivän, kananmunan tai yksinkertaisen kasvisruoan kanssa.'] }] },
      da: { slug: 'tomat-roedloeg-oekologisk-olivenolie-salat', title: 'Tomat-, rødløgs- og økologisk olivenoliesalat', description: 'En hurtig salat med tomat, rødløg og økologisk olivenolie til to personer.', intro: 'Denne salat lader få, veltilberedte ingredienser tale for sig selv.', imageAlt: 'Friske tomater fra Bionaturas katalog.', ctaLabel: 'Se ingredienser i kataloget', sections: [{ heading: 'En salat til hverdagen', paragraphs: ['Skær tomaten lige før servering, så saft og tekstur bevares.', 'Rødløg giver en mild kontrast; tilpas mængden efter din smag.'] }, { heading: 'Servér i roligt tempo', paragraphs: ['Lad salaten trække et par minutter, så smagene samler sig.', 'Servér den med brød, æg eller en enkel grøntsagsret.'] }] },
    },
