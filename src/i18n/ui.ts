...
export const ui = {
  es: {
    ...
    seasonNavigation: 'Temporadas', currentSeason: 'Ahora', seasonSelection: 'Selección de temporada', regularSelection: 'Todo el año', alwaysAvailable: 'Todo el año',
  ...
  en: {
    ...
    seasonNavigation: 'Seasons', currentSeason: 'Now', seasonSelection: 'Seasonal selection', regularSelection: 'All year', alwaysAvailable: 'All year',
    ...
    seasonNavigation: 'Vuodenajat', currentSeason: 'Nyt', seasonSelection: 'Kausivalikoima', regularSelection: 'Ympäri vuoden', alwaysAvailable: 'Ympäri vuoden',
  ...
  da: {
    ...
    seasonNavigation: 'Årstider', currentSeason: 'Nu', seasonSelection: 'Sæsonudvalg', regularSelection: 'Hele året', alwaysAvailable: 'Hele året',
